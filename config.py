...
menu_icon = (
    'https://osu.miksu.pw/static/logos/logo_ingame.png', # image url
    'https://osu.miksu.pw' # onclick url
)

# seasonal backgrounds to be displayed ingame.
seasonal_bgs = ('https://osu.miksu.pw/static/background.jpg',)
